...
<body>
  ...
  <footer id="footer">
    <div id="slideContainer">
      <div id="slide1">
        ...
        <div id="socialBtnContainer">
          <a href="https://www.facebook.com/arnabmondal"><i
              class="fa-brands fa-square-facebook"></i></a>
          <a href="https://www.instagram.com/nowitsarnab"><i class="fa-brands fa-instagram"></i></a>
          <a href="https://www.linkedin.com/in/hello-arnab"><i class="fa-brands fa-linkedin"></i></a>
        </div>
    ...
    <div id="developed">developed by Arnab Mondal</div>
  </footer>
</body>
